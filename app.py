...
def main():
    ...
    st.markdown(f"<div style='text-align: center; margin-top: 15px; font-size: 16px;'><strong>Status:</strong> {badge_label} &nbsp;•&nbsp; <em>Limit used:</em> {active_limit} ft/s</div>", unsafe_allow_html=True)  .stApp { background-color: #e8f7ff; color: #03263a; }
