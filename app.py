...
def main():
    ...
    st.markdown(f"", unsafe_allow_html=True)  .stApp { background-color: #e8f7ff; color: #03263a; }
        ...
        @media (max-width: 768px) {
            table { width: 95% !important; max-width: none !important; }
            th, td { padding: 10px 8px !important; font-size: 14px !important; }
            .kpi-badge { font-size: 16px !important; padding: 6px 10px !important; }
        }
