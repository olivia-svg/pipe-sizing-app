...
def main():
    ...
    <style>
        ...
        /* Style our custom inputs button - REMOVED */
    ...
    def add_pool_water_background():
        if pool_water_b64:
            ...
            /* Tables and content areas - very subtle background */
            .stDataFrame, .stTable {{
                background: rgba(240, 248, 255, 0.3) !important;
                border-radius: 8px !important;
            }}
            /* Text input fields - subtle background for usability */
            ...
            /* Status and recommendation boxes - keep subtle backgrounds */
    ...
    # Re-add pool water background after mobile inputs
    add_pool_water_background()
